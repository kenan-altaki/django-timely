    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.RESTRICT,
                        to="django_timely.resource",
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            name="EventParticipantResource",
            fields=[
                (
                    "id",
                    models.BigAutoField(
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                through="django_timely.EventParticipantResource",
                to="django_timely.resource",
            ),
        ),
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                through="django_timely.EventResource",
                to="django_timely.resource",
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="groups", to="django_timely.resource"
                    ),
                ),
            ],
        ),
        ...
        migrations.AddConstraint(
            model_name="eventparticipantresource",
            constraint=models.UniqueConstraint(
